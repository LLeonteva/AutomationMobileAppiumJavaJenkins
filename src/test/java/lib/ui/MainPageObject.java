...
public class MainPageObject {
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes) {
        ...
        while (driver.findElements(by).size() == 0) { //driver.findElements(by).size(); - how many elements found
    ...
    public void swipeElementToLeft(String locator, String error_message) {
        ...
        action.waitAction(500); // increased from 300 - too fast
    ...
    public List<WebElement> waitAndGetElements(String locator, String error_message, long timeoutInSeconds) {
        By by = this.getLocatorByString(locator);
        waitForElementPresent(locator, error_message, timeoutInSeconds);
        return driver.findElements(by);
    }

    public boolean isContainsSubstr(String str1, String str2) {
